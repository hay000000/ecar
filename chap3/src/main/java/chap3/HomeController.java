...
public class HomeController {
	...
	private Recorder recorder; // recoder = null
	
	@Autowired // 반드시 주입되는 객체가 존재해야함.
				//AlarmDevice 객체와 Viewer 객체를 찾아서 주입
	...
	@PostConstruct //객체생성 완료(DI완료)된후 자동호출되는 메서드
	public void init() {
	...
	@Autowired
	//별명 설정. qualfier 가 intrusionDetection 인 객체들을 주입
